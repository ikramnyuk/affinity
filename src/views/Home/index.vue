<template>
    <div class="page">
		<PageHeader title="Home" :icon="icon" description="Lorem ipsum dolor sit amet."></PageHeader>
...
<script>
	...
	import StatsIcons1 from '../../assets/gross.svg';
				...
				stats: [
					{
						...
						value: '$14,312.20',
						icon: StatsIcons1,
						compare: '57.13% this month',
						compareStatus: 1
					},
					{
						name: 'Lifetime memberships',
						value: '10',
						icon: StatsIcons2,
